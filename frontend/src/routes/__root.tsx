  ...
  head: () => ({
    meta: [
      ...
      { title: "Silicofeller — AI Quantum Chip Design Platform" },
      {
        name: "description",
        content:
          "Silicofeller turns natural-language requirements into optimized quantum chip architectures with AI.",
      },
      ...
      { property: "og:title", content: "Silicofeller — AI Quantum Chip Design Platform" },
      {
        ...
        content:
          "Design fault-tolerant quantum processors from a prompt. AI-generated architectures, layouts, and performance reports.",
      },
