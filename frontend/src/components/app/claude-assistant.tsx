...
import { Sparkles, X, Send, Loader2, ChevronDown, RotateCcw, Copy, Check } from "lucide-react";
...
const PAGE_SUGGESTIONS: Record<string, string[]> = {
  "/designer": [
    "Suggest a heavy-hex topology for 27 qubits",
    "What substrate gives best T₁?",
    "Explain transmon vs fluxonium",
  ],
  "/verification": [
    "Why did my frequency check fail?",
    "What causes ZZ crosstalk?",
    "How do I fix a DRC violation?",
  ],
  "/schematic-editor": [
    "Generate a 5-qubit ring in QCLang",
    "What does connect(Q0,Q1) mean?",
    "Show me a fluxonium example",
  ],
  "/quantum-editor": [
    "How do I connect two qubits in the canvas?",
    "What is a CPW waveguide?",
    "Explain TransmonPocket parameters",
  ],
  "/physics-analysis": [
    "What is anharmonicity?",
    "Explain T1 and T2 times",
    "How does substrate affect coherence?",
  ],
  "/simulations": [
    "What does eigenmode simulation compute?",
    "Explain Q factor",
    "What is driven modal simulation?",
  ],
  default: [
    "What is SILICOFELLER Quantum Studio?",
    "How do I start a new chip design?",
      ...
      setMessages((prev) => {
        ...
        return [
          ...without,
          {
            ...
            content: "⚠️ Backend offline. Start the server with `.venv\\Scripts\\python run.py`",
          },
        ];
      });
    } finally {
          ...
          >
            ...
            <div className="flex items-center justify-between px-4 py-3 border-b border-slate-100 bg-gradient-to-r from-violet-600 to-violet-800 shrink-0">
              ...
              <div className="flex items-center gap-1">
                <button
                  onClick={copyLast}
                  className="h-6 w-6 rounded-lg bg-white/10 flex items-center justify-center text-white/70 hover:bg-white/20 cursor-pointer"
                >
